...
describe('User.password', () => {
  ...
  context('modern flow', () => {
    beforeEach(givenAppWithModernFlow);
    ...
    context('with password-reset token', () => {
  ...
  context('legacy flow', () => {
    beforeEach(givenAppWithLegacyFlow);
  ...
  function givenAppWithModernFlow() {
    return givenAppWithUser({legacyPasswordFlow: false});
  }

  function givenAppWithLegacyFlow() {
    return givenAppWithUser({legacyPasswordFlow: true});
  }
